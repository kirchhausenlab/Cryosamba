...
def setup_run(cfg, mode):
    ...
    can_resume_run = os.path.exists(os.path.join(save_dir, "last.pt")) if mode=="training" else True
    new_run = True
    if os.path.exists(save_dir):
        while True:
            if prompt(f"Dir {save_dir} already exists. Would you like to overwrite it?") == True:
